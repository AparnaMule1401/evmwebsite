...
export default function Grid(){
    const [filterOptions, setFilterOptions] = useState({ type: "", brand: "" });
    const filteredBikes = bike.filter((item) => {
        if (filterOptions.type && filterOptions.brand) {
          return item.Type === filterOptions.type && item.Brand === filterOptions.brand;
        } else if (filterOptions.type) {
          return item.Type === filterOptions.type;
        } else if (filterOptions.brand) {
          return item.Brand === filterOptions.brand;
        } else {
            ...
            <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg">
              ...
              <div className="mb-2">
                ...
                <select
                  name="type"
                  id="type"
                  className="w-full border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-700 rounded-md p-1"
