...
import { scooterDetails } from "../data/data";
...
export default function Grid() {
    ...
    const filteredscooterDetails = scooterDetails.filter(item => {
        if (filterType && item.Type !== filterType) return false;
        if (filterBrand && item.name.toLowerCase() !== filterBrand.toLowerCase()) return false; // Compare in a case-insensitive manner
        return true;
    });
    ...
    return (
        <>
            ...
            <section
                style={{ backgroundImage: "url('/images/bg/b8.jpg')" }}
                    ...
                    <div className="lg:col-span-3 md:col-span-2 col-span-1 lg:col-start-1">
                        <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg">
                            ...
                            <div className="mb-2">
                                ...
                                <select name="type" id="type" className="w-full border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-700 rounded-md p-1" onChange={handleTypeChange}>
                            ...
                            <div className="mb-2">
                                ...
                                <select name="brand" id="brand" className="w-full border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-700 rounded-md p-1" onChange={handleBrandChange}>
                                    <option value="">All</option>
                ...
                <div className="container">
                    <div className="lg:col-span-9 md:col-span-10 col-span-11">
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                            {filteredscooterDetails.map((item, index) => (
