...
import { BikeDetails } from "../data/data"; // Importing BikeDetails
...
export default function Grid() {
    ...
    const filteredBikeDetails = BikeDetails.filter(item => {
        if (filterType && item.Type !== filterType) return false;
        if (filterBrand && item.name !== filterBrand) return false; // Adjusted to use 'name' instead of 'brand'
        return true;
    });
    ...
    return (
        <>
            ...
            <section
                style={{ backgroundImage: "url('/images/bg/b13.jpg')" }}
                ...
                <div className="flex flex-col lg:flex-row">
                    ...
                    <div className="lg:col-span-3 md:col-span-2 col-span-1 lg:col-start-1">
                        <div className="bg-gray-100 dark:bg-gray-800 p-2 rounded-lg">
                            ...
                            <div className="mb-2">
                                ...
                                <select name="type" id="type" value={filterType} onChange={handleTypeChange} className="w-full border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-700 rounded-md p-1">
                            ...
                            <div className="mb-2">
                                ...
                                <select name="brand" id="brand" value={filterBrand} onChange={handleBrandChange} className="w-full border-gray-300 dark:border-gray-600 focus:border-green-500 dark:focus:border-green-500 focus:ring focus:ring-green-200 dark:focus:ring-green-700 rounded-md p-1">
                                    <option value="">All</option>
                                    <option value="Hero">Hero</option>
                                    <option value="Triumph">Triumph</option>
                                    <option value="Scott Strike">Scott</option>
                    ...
                    <div className="lg:col-span-9 md:col-span-10 col-span-11">
                        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                            {filteredBikeDetails.map((item, index) => (
                                <div key={index} className="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                                    {/* Render bike details */}
                                    <div className="relative">
                                        <img src={item.image} alt="" width={400} height={200} style={{ objectFit: 'cover' }} />
