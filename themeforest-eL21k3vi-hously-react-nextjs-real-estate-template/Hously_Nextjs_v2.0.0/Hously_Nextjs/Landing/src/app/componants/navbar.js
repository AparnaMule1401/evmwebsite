                ...
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    {navClass === '' || navClass === undefined ?
                        <Link className="logo" href="/">
                            <Image src="/images/logoev.png" className="inline-block dark:hidden" alt="" width={98} height={24}/>
                            <Image src="/images/logoev.png" className="hidden dark:inline-block" alt="" width={98} height={24} />
                        </Link> :
                        <Link className="logo" href="#">
                            <span className="inline-block dark:hidden">
                                <Image src="/images/logoev.png" className="l-dark"  alt="" width={98} height={24}/>
                                <Image src="/images/logoev.png" className="l-light"  alt="" width={98} height={24}/>
                            </span>
