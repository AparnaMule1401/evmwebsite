            ...
            <section className="relative md:pb-24 pb-16">
                ...
                <div className="container lg:mt-24 mt-16">
                    <div className="grid grid-cols-1 pb-8 text-center">
                        <h3 className="mb-4 md:text-3xl md:leading-normal text-2xl leading-normal font-semibold">Would you like to sell your eV?</h3>
                        <div className="flex justify-center"> {/* Add this wrapper div */}
                        <li className="sm:inline ps-1 mb-0 hidden">
                            <Link href="/list-sidebar" className="btn bg-green-600 hover:bg-green-700 border-green-600 dark:border-green-600 text-white rounded-full">Sell</Link>
                        </li>
</div>
