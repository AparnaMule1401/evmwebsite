...
import {autoDetails} from "../data/data";
...
export default function Grid() {
    ...
    const [filterprice, setFilterprice] = useState("");
        ...
        useEffect(() => {
            filterProperties();
        }, [searchQuery, filterType, filterBrand, filterLocation, filterBattery, filtercolour, filterkilometersDriven, filterprice]);
    ...
    const filterProperties = () => {
        const filtered = autoDetails.filter((property) => {
