...
export default function Grid() {
    ...
    const [filterprice, setFilterprice] = useState("");
        ...
        useEffect(() => {
            filterProperties();
        }, [searchQuery, filterType, filterBrand, filterLocation, filterbodytype, filtercolour, filterkilometersDriven, filterprice]);
    ...
    {/* </div> */}
            ...
            <div className="container">
                ...
                <div className="lg:col-span-9 md:col-span-10 col-span-11">
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px]">
                    {filteredProperties.map((item, index) => (
                            <div key={index} to={`/property-detail/${item.id}`} className="group rounded-xl bg-white dark:bg-slate-900 shadow hover:shadow-xl dark:hover:shadow-xl dark:shadow-gray-700 dark:hover:shadow-gray-700 overflow-hidden ease-in-out duration-500">
                                <div className="relative">

                                <Image src={item.image}alt=""width={0}  height={0} sizes="100vw" style={{ width: '400px', height: '200px', objectFit: 'cover' }}priority/>

                                <div className="absolute top-4 end-4">
                                <Link href="#" className="btn btn-icon bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-full text-slate-100 dark:text-slate-700 focus:text-red-600 dark:focus:text-red-600">
                                <i className="mdi mdi-heart mdi-18px text-gray-700 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-600"></i>
                                </Link>
                               </div>
